  ...
  <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img class="bd-placeholder-img" width="100%" height="100%" src="./imatges/Banner_PHP.jpg" </img>

        <div class="container">
          <div class="carousel-caption text-start">
            <h1>Curs PHP Ceina</h1>
            <p>Un curs de programació innovador i molt pràctic</p>
            <p><a class="btn btn-lg btn-primary" href="#">Em vull apuntar</a></p>
          </div>
        </div>
      </div>
